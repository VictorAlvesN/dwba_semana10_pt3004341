class Descricao extends React.Component {
    constructor(){
        super();
        this.desc = {nome: "Instituto Federal de Educação, Ciência e Tecnologia de São Paulo",   end: "Rua Pedro Vicente, 625 - Canindé - São Paulo - SP - Brasil - Cep: 01109-010"}
      }
    render() {
        return (
            <div>
                <p>O <strong>{this.desc.nome}</strong> – é uma autarquia federal de ensino.</p>
                ...
                <p>Localizado em <strong>{this.desc.end}</strong></p>
            </div>
        );
    }
}
...
ReactDOM.render(<Descricao />, document.getElementById('sobre'));
